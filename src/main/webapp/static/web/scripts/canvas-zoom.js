...
(function () {
    ...
    CanvasZoom.prototype = {
        ...
        gesturePinchZoom: function (event) {
            ...
            websocket.send('focusPointer.x: '+this.focusPointer.x+', focusPointer.y: '+this.focusPointer.y);
            return zoom;
        },
...
//            var newPosY = this.position.y + deltaHeight * coefY;
            var newPosX = this.position.x + (this.focusPointer.x - this.position.x) * (1 - newScale / this.scale.x);
            var newPosY = this.position.y + (this.focusPointer.y - this.position.y) * (1 - newScale / this.scale.y);
            // edges cases
